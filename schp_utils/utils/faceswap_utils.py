...
PREDICTOR_PATH = '/home/vinod/D2B/FlowStyle-Tryon/dress_v2/tryon_v2/tryon_utils_v2/checkpoints/shape_predictor_68_face_landmarks.dat'
...
def face_swapping(src, dst):
    ...
    for k, dst_face in dst_faceBoxes.items():
        output = face_swap(src_face, dst_face["face"], src_points,
                           ...
                           dst_img)
    # save swapped image
    cv2.imwrite("final_result.jpg", output)
    return "Swapped Face Successfully!!!"
